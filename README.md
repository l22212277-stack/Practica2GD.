[![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=l22212277-stack/Practica2GD)

# Práctica 2: Caos en sistemas biológicos

## Información del estudiante
Alberto Villalobos \[22212277]; l22212277.@tijuana.tecn.mx
...
2. Establecer los parámetros y condiciones iniciales del sistema.  
3. Determinar los puntos de equilibrio y analizar su estabilidad mediante la matriz Jacobiana.  
4. Implementar métodos numéricos (Euler, Heun y Runge-Kutta) para resolver el sistema.  
5. Simular y analizar distintos comportamientos dinámicos (caos, órbitas y ciclos límite).  
6. Comparar las soluciones obtenidas y evaluar el error entre métodos numéricos.  
7. Incorporar un término de control (inmunoterapia) y analizar su efecto en la dinámica del sistema.  
...
